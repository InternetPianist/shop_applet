...
3 点击 加入购物车
  ...
  4 已经存在 修改商品数据 执行购物车数量++ 重把购物车数组 填充回缓存中
  5 不存在于购物车的数组中 直接给购物车数组添加一个新元素 新元素 带上 购物数量属性 num 重新把购物车数组 填充回缓存中
  6 弹出提示
4 商品收藏
...
Page({
  ...
  //  const {goods_price,goods_name,goods_introduce,pics} = await request({url: '/goods/detail',data: {goods_id}})
   this.setData({
     goodsObj:{
